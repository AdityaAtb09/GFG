<h2><a href="https://practice.geeksforgeeks.org/problems/riyas-test1450/1?page=2&category=Strings&difficulty=Basic&sortBy=difficulty">Same frequency in two halves</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S, find whether it fulfills the following criteria.&nbsp;<br>
