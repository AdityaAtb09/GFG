<h2><a href="https://practice.geeksforgeeks.org/problems/next-greater-even-number0828/1?page=1&category=Strings&difficulty=Easy&sortBy=difficulty">Next Greater Even Number</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer <strong>X</strong>. The task is to find the smallest even number <strong>E</strong> such that<br>
